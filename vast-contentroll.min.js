...
(function(){var g=document.createElement("script");g.async=!0;g.src="https://imasdk.googleapis.com/js/sdkloader/ima3.js";g.onload=function(){function f(a,c,b){c="data-"+c;return"undefined"!==typeof b?a.setAttribute(c,b):a.getAttribute(c)}function b(a,c,b){return"undefined"!==typeof b?f(a,c,b?"1":"0"):~["1","true"].indexOf(f(a,c))?!0:!1}function e(a,c){b(a,d.DEBUG)&&console.log("vast-contentroll:",c)}function g(a){b(a,d.CONTROLLS)||(b(a,d.CONTROLLS,1),a.muteButton=document.createElement("a"),a.muteButton.className=
    ...
    (a.adsManager.setVolume(0),e(a,"mute clicked"),this.textContent=f(a,"unmute-text")||"Unmute")},a.appendChild(a.muteButton))}var d={INIT:"init",LOADING:"loading",LOADED:"loaded",STARTED:"started",CONTROLLS:"controlls",DEBUG:"debug",COLLAPSE:"collapse",COMPANION:"companion"},l=document.getElementsByClassName("vast-contentroll"),h=new IntersectionObserver(function(a){[].forEach.call(a,function(a){"undefined"!==typeof a.isIntersecting&&!1===a.isIntersecting?(a=a.target,b(a,d.STARTED)&&(a.adsManager.pause(),
    e(a,"pauseAd"))):(a=a.target,b(a,d.STARTED)?(a.adsManager.resume(),e(a,"resumeAd")):b(a,d.LOADING)?e(a,"yet loading"):(e(a,"load"),a.adsRequest.adTagUrl=f(a,"vast"),a.adsLoader.requestAds(a.adsRequest),b(a,d.LOADING,1)))})},{threshold:0});[].forEach.call(l,function(a){b(a,d.INIT)||(h.observe(a),a.adDisplayContainer=new google.ima.AdDisplayContainer(a),a.adDisplayContainer.initialize(),a.adsLoader=new google.ima.AdsLoader(a.adDisplayContainer),a.adsRequest=new google.ima.AdsRequest,a.adsLoader.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,
    function(c){a.adsManager=c.getAdsManager(document.createElement("video"));a.adsManager.addEventListener(google.ima.AdEvent.Type.LOADED,function(c){b(a,d.LOADED,1)});a.adsManager.addEventListener(google.ima.AdEvent.Type.STARTED,function(c){b(a,d.STARTED,1);g(a);if(b(a,d.COMPANION)){e(a,"get a list of companion ads");c=c.getAd();var f=new google.ima.CompanionAdSelectionSettings;f.resourceType=google.ima.CompanionAdSelectionSettings.ResourceType.STATIC;f.creativeType=google.ima.CompanionAdSelectionSettings.CreativeType.IMAGE;
        f.sizeCriteria=google.ima.CompanionAdSelectionSettings.SizeCriteria.IGNORE;a.companionAds=c.getCompanionAds(a.clientWidth,a.clientHeight,f);e(a,"getted companion ads count: "+a.companionAds.length)}});a.adsManager.addEventListener(google.ima.AdEvent.Type.ALL_ADS_COMPLETED,function(c){e(a,"ALL_ADS_COMPLETED");a.removeChild(a.muteButton);h.unobserve(a);b(a,d.COMPANION)&&a.companionAds&&a.companionAds.length?(a.innerHTML=a.companionAds[0].getContent(),a.style.height="auto",e(a,"display companion")):
        b(a,d.COLLAPSE)&&(a.style.height="0",e(a,"ads collapsed"))});try{a.adsManager.init(a.clientWidth,a.clientHeight,google.ima.ViewMode.NORMAL),a.adsManager.start()}catch(k){e(a,"error or empty ad",k)}},!1),a.adsLoader.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,function(b){console.log(b.getError());a.adsManager.destroy()},!1),b(a,d.INIT,1),b(a,d.LOADED,0),b(a,d.STARTED,0),e(a,"init"))})};document.head.appendChild(g)})();
