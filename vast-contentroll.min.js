...
(function(){var g=document.createElement("script");g.async=!0;g.src="https://imasdk.googleapis.com/js/sdkloader/ima3.js";g.onload=function(){function h(a,b,e){b="data-"+b;return"undefined"!==typeof e?a.setAttribute(b,e):a.getAttribute(b)}function c(a,b,e){return"undefined"!==typeof e?h(a,b,e?"1":"0"):~["1","true"].indexOf(h(a,b))?!0:!1}function f(a,b){c(a,d.DEBUG)&&console.log("vast-contentroll:",b)}function g(a){c(a,d.CONTROLLS)||(c(a,d.CONTROLLS,1),a.muteButton=document.createElement("a"),a.muteButton.className=
    ...
    e>b?f(a,"adapt size skiped"):(a.style.width=e+"px",a.style.height=c+"px",a.style.maxWidth="100%",f(a,"size adapted"))}var d={INIT:"init",LOADING:"loading",LOADED:"loaded",STARTED:"started",CONTROLLS:"controlls",DEBUG:"debug",COLLAPSE:"collapse",COMPANION:"companion",RESPONSIVE:"responsive"},n=document.getElementsByClassName("vast-contentroll"),l=new IntersectionObserver(function(a){[].forEach.call(a,function(a){"undefined"!==typeof a.isIntersecting&&!1===a.isIntersecting?(a=a.target,c(a,d.STARTED)&&
(a.adsManager.pause(),f(a,"pauseAd"))):(a=a.target,c(a,d.STARTED)?(a.adsManager.resume(),f(a,"resumeAd")):c(a,d.LOADING)?f(a,"yet loading"):(f(a,"load"),a.adsRequest.adTagUrl=h(a,"vast"),a.adsLoader.requestAds(a.adsRequest),c(a,d.LOADING,1)))})},{threshold:0});[].forEach.call(n,function(a){c(a,d.INIT)||(c(a,d.RESPONSIVE)&&m(a),l.observe(a),a.adDisplayContainer=new google.ima.AdDisplayContainer(a),a.adDisplayContainer.initialize(),a.adsLoader=new google.ima.AdsLoader(a.adDisplayContainer),a.adsRequest=
    ...
    google.ima.CompanionAdSelectionSettings.ResourceType.STATIC;b.creativeType=google.ima.CompanionAdSelectionSettings.CreativeType.IMAGE;b.sizeCriteria=google.ima.CompanionAdSelectionSettings.SizeCriteria.IGNORE;a.companionAds=e.getCompanionAds(a.clientWidth,a.clientHeight,b);f(a,"getted companion ads count: "+a.companionAds.length)}});a.adsManager.addEventListener(google.ima.AdEvent.Type.ALL_ADS_COMPLETED,function(b){k(a,b)});try{a.adsManager.init(a.clientWidth,a.clientHeight,google.ima.ViewMode.NORMAL),
    a.adsManager.start()}catch(e){f(a,"error or empty ad",e)}},!1),a.adsLoader.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,function(b){f(a,"error or empty ad",b.getError());"undefined"!==typeof a.adsManager&&a.adsManager.destroy();k(a)},!1),c(a,d.INIT,1),c(a,d.LOADED,0),c(a,d.STARTED,0),f(a,"init"))})};document.head.appendChild(g)})();
