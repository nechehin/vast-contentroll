 ...
 */
function(){var f=document.createElement("script");f.async=!0;f.src="https://imasdk.googleapis.com/js/sdkloader/ima3.js";f.onload=function(){function g(a,c,b){c="data-"+c;return"undefined"!==typeof b?a.setAttribute(c,b):a.getAttribute(c)}function b(a,c,b){return"undefined"!==typeof b?g(a,c,b?"1":"0"):~["1","true"].indexOf(g(a,c))?!0:!1}function e(a,c){b(a,d.DEBUG)&&console.log("vast-contentroll:",c)}function f(a){a.muteButton=document.createElement("a");a.muteButton.className="vast-contentroll--btn-mute";
    a.muteButton.textContent=g(a,"mute-text")||"Mute";a.muteButton.style.position="relative";a.muteButton.style.padding="8px 16px";a.muteButton.style.backgroundColor="rgba(0,0,0,0.8)";a.muteButton.style.color="#e6e6e6";a.muteButton.style.fontFamily="arial";a.muteButton.style.fontSize="12px";a.muteButton.style.cursor="pointer";a.muteButton.onclick=function(){0===a.adsManager.getVolume()?(e(a,"unmute clicked"),a.adsManager.setVolume(1),this.textContent=g(a,"mute-text")||"Mute"):(a.adsManager.setVolume(0),
        e(a,"mute clicked"),this.textContent=g(a,"unmute-text")||"Unmute")};a.appendChild(a.muteButton)}var d={INIT:"init",LOADED:"loaded",STARTED:"started",DEBUG:"debug",COLLAPSE:"collapse"},l=document.getElementsByClassName("vast-contentroll"),h=new IntersectionObserver(function(a){[].forEach.call(a,function(a){"undefined"!==typeof a.isIntersecting&&!1===a.isIntersecting?(a=a.target,b(a,d.STARTED)&&(a.adsManager.pause(),e(a,"pauseAd"))):(a=a.target,b(a,d.STARTED)?(a.adsManager.resume(),e(a,"resumeAd")):
    (e(a,"load"),a.adsRequest.adTagUrl=g(a,"vast"),a.adsLoader.requestAds(a.adsRequest)))})},{threshold:0});[].forEach.call(l,function(a){b(a,d.INIT)||(h.observe(a),a.adDisplayContainer=new google.ima.AdDisplayContainer(a),a.adDisplayContainer.initialize(),a.adsLoader=new google.ima.AdsLoader(a.adDisplayContainer),a.adsRequest=new google.ima.AdsRequest,a.adsLoader.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(c){a.adsManager=c.getAdsManager(document.createElement("video"));
    a.adsManager.addEventListener(google.ima.AdEvent.Type.LOADED,function(){b(a,d.LOADED,1)});a.adsManager.addEventListener(google.ima.AdEvent.Type.STARTED,function(){b(a,d.STARTED,1);f(a)});a.adsManager.addEventListener(google.ima.AdEvent.Type.ALL_ADS_COMPLETED,function(){e(a,"ALL_ADS_COMPLETED");a.removeChild(a.muteButton);h.unobserve(a);b(a,d.COLLAPSE)&&(a.style.height="0",e(a,"ads collapsed"))});try{a.adsManager.init(a.clientWidth,a.clientHeight,google.ima.ViewMode.NORMAL),a.adsManager.start()}catch(k){e(a,
        "error or empty ad",k)}},!1),a.adsLoader.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,function(b){console.log(b.getError());a.adsManager.destroy()},!1),b(a,d.INIT,1),b(a,d.LOADED,0),b(a,d.STARTED,0),e(a,"init"))})};document.head.appendChild(f)})();
