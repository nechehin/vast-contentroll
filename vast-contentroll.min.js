 ...
 */
(function(){var g=document.createElement("script");g.async=!0;g.src="https://imasdk.googleapis.com/js/sdkloader/ima3.js";g.onload=function(){function h(a,b,e){b="data-"+b;return"undefined"!==typeof e?a.setAttribute(b,e):a.getAttribute(b)}function c(a,b,e){return"undefined"!==typeof e?h(a,b,e?"1":"0"):~["1","true"].indexOf(h(a,b))?!0:!1}function f(a,b){c(a,d.DEBUG)&&console.log("vast-contentroll:",b)}function g(a){c(a,d.CONTROLLS)||(c(a,d.CONTROLLS,1),a.muteButton=document.createElement("a"),a.muteButton.className=
    "vast-contentroll--btn-mute",a.muteButton.textContent=h(a,"mute-text")||"Mute",a.muteButton.style.position="relative",a.muteButton.style.padding="8px 16px",a.muteButton.style.backgroundColor="rgba(0,0,0,0.8)",a.muteButton.style.color="#e6e6e6",a.muteButton.style.fontFamily="arial",a.muteButton.style.fontSize="12px",a.muteButton.style.cursor="pointer",a.muteButton.onclick=function(){0===a.adsManager.getVolume()?(f(a,"unmute clicked"),a.adsManager.setVolume(1),this.textContent=h(a,"mute-text")||"Mute"):
    (a.adsManager.setVolume(0),f(a,"mute clicked"),this.textContent=h(a,"unmute-text")||"Unmute")},a.appendChild(a.muteButton))}function k(a){f(a,"ALL_ADS_COMPLETED");a.muteButton&&a.removeChild(a.muteButton);l.unobserve(a);c(a,d.COMPANION)&&a.companionAds&&a.companionAds.length?(a.innerHTML=a.companionAds[0].getContent(),a.style.height="auto",f(a,"display companion")):c(a,d.COLLAPSE)&&(a.style.height="0",f(a,"ads collapsed"))}function m(a){var b=a.clientWidth,e=a.parentNode.clientWidth,c=e/b*a.clientHeight;
    e>b?f(a,"adapt size skiped"):(a.style.width=e+"px",a.style.height=c+"px",f(a,"size adapted"))}var d={INIT:"init",LOADING:"loading",LOADED:"loaded",STARTED:"started",CONTROLLS:"controlls",DEBUG:"debug",COLLAPSE:"collapse",COMPANION:"companion",RESPONSIVE:"responsive"},n=document.getElementsByClassName("vast-contentroll"),l=new IntersectionObserver(function(a){[].forEach.call(a,function(a){"undefined"!==typeof a.isIntersecting&&!1===a.isIntersecting?(a=a.target,c(a,d.STARTED)&&(a.adsManager.pause(),
    f(a,"pauseAd"))):(a=a.target,c(a,d.STARTED)?(a.adsManager.resume(),f(a,"resumeAd")):c(a,d.LOADING)?f(a,"yet loading"):(f(a,"load"),a.adsRequest.adTagUrl=h(a,"vast"),a.adsLoader.requestAds(a.adsRequest),c(a,d.LOADING,1)))})},{threshold:0});[].forEach.call(n,function(a){c(a,d.INIT)||(c(a,d.RESPONSIVE)&&m(a),l.observe(a),a.adDisplayContainer=new google.ima.AdDisplayContainer(a),a.adDisplayContainer.initialize(),a.adsLoader=new google.ima.AdsLoader(a.adDisplayContainer),a.adsRequest=new google.ima.AdsRequest,
    a.adsLoader.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(b){a.adsManager=b.getAdsManager(document.createElement("video"));a.adsManager.addEventListener(google.ima.AdEvent.Type.LOADED,function(e){c(a,d.LOADED,1)});a.adsManager.addEventListener(google.ima.AdEvent.Type.STARTED,function(e){c(a,d.STARTED,1);g(a);if(c(a,d.COMPANION)){f(a,"get a list of companion ads");e=e.getAd();var b=new google.ima.CompanionAdSelectionSettings;b.resourceType=google.ima.CompanionAdSelectionSettings.ResourceType.STATIC;
        b.creativeType=google.ima.CompanionAdSelectionSettings.CreativeType.IMAGE;b.sizeCriteria=google.ima.CompanionAdSelectionSettings.SizeCriteria.IGNORE;a.companionAds=e.getCompanionAds(a.clientWidth,a.clientHeight,b);f(a,"getted companion ads count: "+a.companionAds.length)}});a.adsManager.addEventListener(google.ima.AdEvent.Type.ALL_ADS_COMPLETED,function(b){k(a,b)});try{a.adsManager.init(a.clientWidth,a.clientHeight,google.ima.ViewMode.NORMAL),a.adsManager.start()}catch(e){f(a,"error or empty ad",
        e)}},!1),a.adsLoader.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,function(b){f(a,"error or empty ad",b.getError());"undefined"!==typeof a.adsManager&&a.adsManager.destroy();k(a)},!1),c(a,d.INIT,1),c(a,d.LOADED,0),c(a,d.STARTED,0),f(a,"init"))})};document.head.appendChild(g)})();
