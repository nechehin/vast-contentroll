...
(function(){var k=document.createElement("script");k.async=!0;k.src="https://imasdk.googleapis.com/js/sdkloader/ima3.js";k.onload=function(){function f(a,e,b){e="data-"+e;return"undefined"!==typeof b?a.setAttribute(e,b):a.getAttribute(e)}function g(a,e,b){return"undefined"!==typeof b?f(a,e,b?"1":"0"):~["1","true"].indexOf(f(a,e))?!0:!1}function c(a,e,b){g(a,h.DEBUG)&&console.log("vast-contentroll:",e,b||"")}function k(a){g(a,h.CONTROLLS)||(g(a,h.CONTROLLS,1),a.muteButton=document.createElement("a"),
    ...
    a.adsManager.setVolume(1),this.textContent=f(a,"mute-text")||"Mute"):(a.adsManager.setVolume(0),c(a,"mute clicked"),this.textContent=f(a,"unmute-text")||"Unmute")},a.appendChild(a.muteButton))}function q(a){l.unobserve(a);a.style.height="0";a=f(a,"on-empty");if("function"===typeof window[a])window[a]()}function r(a){var e=a.clientWidth,b=a.parentNode.clientWidth,d=b/e*a.clientHeight;b>e?c(a,"adapt size skiped"):(a.style.position="relative",a.style.overflow="hidden",a.style.width=b+"px",a.style.height=
